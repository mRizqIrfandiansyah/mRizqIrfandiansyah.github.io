	...
	<tr>
		<td width="30%">
			...
			<div class="image_preview1">
    			<img src="gambar/batik1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor" width="100%">
				<div id="myModal" class="modal">
					<span class="close cursor" onclick="closeModal()">&times;</span>
					<div class="modal-content">
					    <div class="mySlides">
					      <div class="numbertext">1 / 4</div>
					      <img src="gambar/batik1.jpg" style="width:100%">
					    </div>
					    <div class="mySlides">
					      <div class="numbertext">2 / 4</div>
					      <img src="gambar/batik2.jpg" style="width:100%">
					    </div>

					    <div class="mySlides">
					      <div class="numbertext">3 / 4</div>
					      <img src="gambar/batik3.jpg" style="width:100%">
					    </div>
					    
					    <div class="mySlides">
					      <div class="numbertext">4 / 4</div>
					      <img src="gambar/batik5.jpg" style="width:100%">
					    </div>
					    ...
					    <div class="column">
					      <img class="demo cursor" src="gambar/batik1.jpg" style="width:100%" onclick="currentSlide(1)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="gambar/batik2.jpg" style="width:100%" onclick="currentSlide(2)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="gambar/batik3.jpg" style="width:100%" onclick="currentSlide(3)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="gambar/batik5.jpg" style="width:100%" onclick="currentSlide(4)" >
					    </div>
					</div>
				</div>
			</div>
			<div id="image_slider">
				<img class="image_preview2" src="gambar/batik2.jpg">
				<img class="image_preview2" src="gambar/batik3.jpg">
				<img class="image_preview2" src="gambar/batik5.jpg">
			</div>
		</td>
		<td id="content">
			<table cellspacing="0" cellpadding="10px">
				<tr>
					<td colspan="2" style="border-bottom:solid gray;">
						...
						<br>
						<br>
						<p> Baju batik Jogja all size (S,M,L,XL,XXL) warna yang tersedia : Merah, Biru, Hijau, Orange, Ungu
					</td>
				</tr>
				<tr>
					<td valign="top" >
