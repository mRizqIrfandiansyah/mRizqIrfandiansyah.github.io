...
<div id="header" >
	...
	<tr>
		<td colspan="3" width="100%">
			<a href="index.php">Home</a> > <a href="kerajinan.php">Kerajinan</a> > <a href="">Souvenir Gantungan Kunci Wayang Batik</a>
		</td>
	</tr>
	<tr>
		<td colspan="3" width="100%"><h2>Souvenir Gantungan Kunci Wayang Batik</h2></td>
	</tr>
	<tr>
		<td width="25%" valign="top">
			<div class="image_preview1">
    			<img src="img/kunci_1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor" width="100%">
				<div id="myModal" class="modal">
					<span class="close cursor" onclick="closeModal()">&times;</span>
					<div class="modal-content">
					    <div class="mySlides">
					      <div class="numbertext">1 / 5</div>
					      <img src="img/kunci_1.jpg" style="width:100%">
					    </div>
					    <div class="mySlides">
					      <div class="numbertext">2 / 5</div>
					      <img src="img/kunci_2.jpg" style="width:100%">
					    </div>

					    <div class="mySlides">
					      <div class="numbertext">3 / 5</div>
					      <img src="img/kunci_3.jpg" style="width:100%">
					    </div>
						<div class="mySlides">
					      <div class="numbertext">4 / 5</div>
					      <img src="img/kunci_4.jpg" style="width:100%">
					    </div>
						<div class="mySlides">
					      <div class="numbertext">5 / 5</div>
					      <img src="img/kunci_5.jpg" style="width:100%">
					    </div>
					    ...
					    <div class="column">
					      <img class="demo cursor" src="img/kunci_1.jpg" style="width:100%" onclick="currentSlide(1)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="img/kunci_2.jpg" style="width:100%" onclick="currentSlide(2)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="img/kunci_3.jpg" style="width:100%" onclick="currentSlide(3)" >
					    </div>
						<div class="column">
					      <img class="demo cursor" src="img/kunci_4.jpg" style="width:100%" onclick="currentSlide(4)" >
					    </div>
						<div class="column">
					      <img class="demo cursor" src="img/kunci_5.jpg" style="width:100%" onclick="currentSlide(5)" >
					    </div>
					</div>
				</div>
			</div>
			<div id="image_slider">
				<img class="image_preview2" src="img/kunci_1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/kunci_2.jpg" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/kunci_3.jpg" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/kunci_4.jpg" onclick="openModal();currentSlide(4)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/kunci_5.jpg" onclick="openModal();currentSlide(5)" class="hover-shadow cursor">
			</div>
		</td>
			...
			<table width="100%" cellspacing="0" cellpadding="10px">
				<tr>
					<td colspan="2" style="border-bottom:solid gray;">
						<p>Deskripsi Produk
<p>
Gantungan Kunci Wayang Batik ini tersedia dalam berbagai macam warna motif dan jenis wayang yang menarik.
Gantungan kunci ini terbuat dari kayu.
Sangat menarik untuk dijadikan Souvenir, Oleh-Oleh, Hadiah, atau acara khusus lainnya yang khas Indonesia.
Pemilihan jenis wayang akan kami sesuaikan dengan stok yang tersedia.
Terima Kasih
				...
				<tr>
					...
					<td rowspan="2" align="center">
						<div style="border:2px solid black;font-weight:bold;padding:10px">
							<h2 style="margin:0">Rating</h2><br><hr><font size="30" color="orange">4.5</font>
						</div>
					</td>
				</tr>
				<tr>
			...
			<table cellspacing="0" cellpadding="10px" width="100%">
				<tr>
					<td align="center" valign="top">
						<h2>Harga</h2>
						<hr>
						<font size="30" color="red">Rp 5.000</font>
						<p align="center">Stok
					<div align="center" style="border:1px solid lightgrey;
					width:30%;margin:0 auto;font-size:50;border-radius:10px" id="stok">100</div>
					</td>
				</tr>
				<tr>
					<td>
					<div class="number-input" align="center">
  						...
  						<input id="kurang" class="quantity" min="0" max="100"name="quantity" value="1" type="number">
