...
<div id="header" >
	...
	<tr>
		<td colspan="3" width="100%">
			<a href="index.php">Home</a> > <a href="pakaian.php">Pakaian</a> > <a href="">Baju Couple Batik Mega Mendung</a>
		</td>
	</tr>
	<tr>
		<td colspan="3" width="100%"><h2>Baju Couple Batik Mega Mendung</h2></td>
	</tr>
	<tr>
		<td width="25%" valign="top">
			<div class="image_preview1">
    			<img src="img/batik1_1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor" width="100%">
				<div id="myModal" class="modal">
					<span class="close cursor" onclick="closeModal()">&times;</span>
					<div class="modal-content">
					    <div class="mySlides">
					      <div class="numbertext">1 / 4</div>
					      <img src="img/batik1_1.jpg" style="width:100%">
					    </div>
					    <div class="mySlides">
					      <div class="numbertext">2 / 4</div>
					      <img src="img/batik1_2.jpg" style="width:100%">
					    </div>

					    <div class="mySlides">
					      <div class="numbertext">3 / 4</div>
					      <img src="img/batik1_3.jpg" style="width:100%">
					    </div>
						<div class="mySlides">
					      <div class="numbertext">4 / 4</div>
					      <img src="img/batik1_4.jpg" style="width:100%">
					    </div>
					    ...
					    <div class="column">
					      <img class="demo cursor" src="img/batik1_1.jpg" style="width:100%" onclick="currentSlide(1)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="img/batik1_2.jpg" style="width:100%" onclick="currentSlide(2)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="img/batik1_3.jpg" style="width:100%" onclick="currentSlide(3)" >
					    </div>
						<div class="column">
					      <img class="demo cursor" src="img/batik1_4.jpg" style="width:100%" onclick="currentSlide(4)" >
					    </div>
					</div>
				</div>
			</div>
			<div id="image_slider">
				<img class="image_preview2" src="img/batik1_1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/batik1_2.jpg" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/batik1_3.jpg" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/batik1_4.jpg" onclick="openModal();currentSlide(4)" class="hover-shadow cursor">
			</div>
		</td>
...
Size Cowok
M lebar dada 52 cm panjang 68cm,
L lebar dada 54 cm panjang 69cm,
XL lebar dada 56 cm panjang 70cm

Size Cewek:
M lebar dada 44cm, Panjang baju 65cm.
L lebar dada 45cm, Panjang baju 66cm.
XL lebar dada 47cm, Panjang baju 67cm.
</pre>
					</td>
				</tr>
				<tr>
			...
			<table cellspacing="0" cellpadding="10px" width="100%">
				<tr>
					<td align="center" valign="top">
						<h2>Harga</h2>
						<hr>
						<font size="30" color="red">Rp 200.000</font>
						<p align="center">Stok
				...
				<tr>
					...
					<div class="number-input" align="center">
  						...
  						<input id="kurang" class="quantity" min="0" max="30"name="quantity" value="1" type="number">
