...
<div id="header" >
	...
	<tr>
		<td colspan="3" width="100%">
			<a href="index.php">Home</a> > <a href="pakaian.php">Pakaian</a> > <a href="">Kemeja Lengan Pendek Batik Pria Katun Halus</a>
		</td>
	</tr>
	<tr>
		<td colspan="3" width="100%"><h2>Kemeja Lengan Pendek Batik Pria Katun Halus</h2></td>
	</tr>
	<tr>
		<td width="25%" valign="top">
			<div class="image_preview1">
    			<img src="img/batik2_1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor" width="100%">
				<div id="myModal" class="modal">
					<span class="close cursor" onclick="closeModal()">&times;</span>
					<div class="modal-content">
					    <div class="mySlides">
					      <div class="numbertext">1 / 4</div>
					      <img src="img/batik2_1.jpg" style="width:100%">
					    </div>
					    <div class="mySlides">
					      <div class="numbertext">2 / 4</div>
					      <img src="img/batik2_2.jpg" style="width:100%">
					    </div>

					    <div class="mySlides">
					      <div class="numbertext">3 / 4</div>
					      <img src="img/batik2_3.jpg" style="width:100%">
					    </div>
					    ...
					    <div class="column">
					      <img class="demo cursor" src="img/batik2_1.jpg" style="width:100%" onclick="currentSlide(1)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="img/batik2_2.jpg" style="width:100%" onclick="currentSlide(2)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="img/batik2_3.jpg" style="width:100%" onclick="currentSlide(3)" >
					    </div>
					</div>
				</div>
			</div>
			<div id="image_slider">
				<img class="image_preview2" src="img/batik2_1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/batik2_2.jpg" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/batik2_3.jpg" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
			</div>
		</td>
			...
			<table width="100%" cellspacing="0" cellpadding="10px">
				<tr>
					<td colspan="2" style="border-bottom:solid gray;">
						<p>Deskripsi Produk
<pre>
size tersedia : M , L , XL
material : cotton
tersedia :
M : 1D RED ,1D BLUE, 1G RED,1G GREEN, 1F PURPLE
L : 1D RED ,1G RED, 1G GREEN
XL : 1F PURPLE, 1D BLUE,1D RED,1G RED, 1G GREEN

DETAIL SIZE
M= LEBAR DADA 54CM x 71CM LEBAR BAHU 47CM PANJANG LENGAN 24CM
L = LEBAR DADA 57CM x 73CM LEBAR BAHU 49CM PANJANG LENGAN 25CM
XL= LEBAR DADA 59CM x 75CM LEBAR BAHU 51CM PANJANG LENGAN 26CM
			...
			<table cellspacing="0" cellpadding="10px" width="100%">
				<tr>
					<td align="center" valign="top">
						<h2>Harga</h2>
						<hr>
						<font size="30" color="red">Rp 70.000</font>
						<p align="center">Stok
					<div align="center" style="border:1px solid lightgrey;
					width:30%;margin:0 auto;font-size:50;border-radius:10px" id="stok">28</div>
					</td>
				</tr>
				<tr>
					<td>
					<div class="number-input" align="center">
  						...
  						<input id="kurang" class="quantity" min="0" max="28"name="quantity" value="1" type="number">
