...
<div id="header" >
	...
	<tr>
		<td colspan="3" width="100%">
			<a href="index.php">Home</a> > <a href="pakaian.php">Pakaian</a> > <a href="">Callista V-Neck Tee Kaos Batik Polo Wanita</a>
		</td>
	</tr>
	<tr>
		<td colspan="3" width="100%"><h2>Callista V-Neck Tee Kaos Batik Polo Wanita</h2></td>
	</tr>
	<tr>
		<td width="25%" valign="top">
			<div class="image_preview1">
    			<img src="img/batik3_1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor" width="100%">
				<div id="myModal" class="modal">
					<span class="close cursor" onclick="closeModal()">&times;</span>
					<div class="modal-content">
					    <div class="mySlides">
					      <div class="numbertext">1 / 4</div>
					      <img src="img/batik3_1.jpg" style="width:100%">
					    </div>
					    <div class="mySlides">
					      <div class="numbertext">2 / 4</div>
					      <img src="img/batik3_2.jpg" style="width:100%">
					    </div>

					    <div class="mySlides">
					      <div class="numbertext">3 / 4</div>
					      <img src="img/batik3_3.jpg" style="width:100%">
					    </div>
						<div class="mySlides">
					      <div class="numbertext">4 / 4</div>
					      <img src="img/batik3_4.jpg" style="width:100%">
					    </div>
					    ...
					    <div class="column">
					      <img class="demo cursor" src="img/batik3_1.jpg" style="width:100%" onclick="currentSlide(1)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="img/batik3_2.jpg" style="width:100%" onclick="currentSlide(2)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="img/batik3_3.jpg" style="width:100%" onclick="currentSlide(3)" >
					    </div>
						<div class="column">
					      <img class="demo cursor" src="img/batik3_4.jpg" style="width:100%" onclick="currentSlide(4)" >
					    </div>
					</div>
				</div>
			</div>
			<div id="image_slider">
				<img class="image_preview2" src="img/batik3_1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/batik3_2.jpg" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/batik3_3.jpg" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/batik3_4.jpg" onclick="openModal();currentSlide(4)" class="hover-shadow cursor">
			</div>
		</td>
			...
			<table width="100%" cellspacing="0" cellpadding="10px">
				<tr>
					<td colspan="2" style="border-bottom:solid gray;">
						<p>Deskripsi Produk
<pre>
ALL SIZE/FREE SIZE/HANYA SATU UKURAN
			...
			<table cellspacing="0" cellpadding="10px" width="100%">
				<tr>
					<td align="center" valign="top">
						<h2>Harga</h2>
						<hr>
						<font size="30" color="red">Rp 55.000</font>
						<p align="center">Stok
