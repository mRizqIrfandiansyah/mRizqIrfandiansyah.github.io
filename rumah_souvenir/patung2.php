...
<div id="header" >
	...
	<tr>
		<td colspan="3" width="100%">
			<a href="index.php">Home</a> > <a href="kerajinan.php">Kerajinan</a> > <a href="">Patung Naga Elang Kayu Jati</a>
		</td>
	</tr>
	<tr>
		<td colspan="3" width="100%"><h2>Patung Naga Elang Kayu Jati</h2></td>
	</tr>
	<tr>
		<td width="25%" valign="top">
			<div class="image_preview1">
    			<img src="img/patung2.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor" width="100%">
				<div id="myModal" class="modal">
					<span class="close cursor" onclick="closeModal()">&times;</span>
					<div class="modal-content">
					    <div class="mySlides">
					      <div class="numbertext">1 / 1</div>
					      <img src="img/patung2.jpg" style="width:100%">
					    </div>
					    ...
					    <div class="column">
					      <img class="demo cursor" src="img/patung2.jpg" style="width:100%" onclick="currentSlide(1)" >
					    </div>
					</div>
				</div>
			</div>
			<div id="image_slider">
				<img class="image_preview2" src="img/patung2.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
			</div>
		</td>
		...
		<td id="content" width="25%">
			<table cellspacing="0" cellpadding="10px" width="100%">
				<tr>
					...
					width:30%;margin:0 auto;font-size:50;border-radius:10px" id="stok">10</div>
					</td>
				</tr>
				<tr>
					<td>
					<div class="number-input" align="center">
  						...
  						<input id="kurang" class="quantity" min="0" max="10"name="quantity" value="1" type="number">
