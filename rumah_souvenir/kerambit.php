...
<div id="header" >
	...
	<tr>
		<td colspan="3" width="100%">
			<a href="index.php">Home</a> > <a href="kerajinan.php">Kerajinan</a> > <a href="">Kerambit Tradisional Kayu</a>
		</td>
	</tr>
	<tr>
		<td colspan="3" width="100%"><h2>Kerambit Tradisional Kayu</h2></td>
	</tr>
	<tr>
		<td width="25%" valign="top">
			<div class="image_preview1">
    			<img src="img/kerambit1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor" width="100%">
				<div id="myModal" class="modal">
					<span class="close cursor" onclick="closeModal()">&times;</span>
					<div class="modal-content">
					    <div class="mySlides">
					      <div class="numbertext">1 / 4</div>
					      <img src="img/kerambit1.jpg" style="width:100%">
					    </div>
					    <div class="mySlides">
					      <div class="numbertext">2 / 4</div>
					      <img src="img/kerambit2.jpg" style="width:100%">
					    </div>

					    <div class="mySlides">
					      <div class="numbertext">3 / 4</div>
					      <img src="img/kerambit3.jpg" style="width:100%">
					    </div>
						<div class="mySlides">
					      <div class="numbertext">4 / 4</div>
					      <img src="img/kerambit4.jpg" style="width:100%">
					    </div>
					    ...
					    <div class="column">
					      <img class="demo cursor" src="img/kerambit1.jpg" style="width:100%" onclick="currentSlide(1)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="img/kerambit2.jpg" style="width:100%" onclick="currentSlide(2)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="img/kerambit3.jpg" style="width:100%" onclick="currentSlide(3)" >
					    </div>
						 <div class="column">
					      <img class="demo cursor" src="img/kerambit4.jpg" style="width:100%" onclick="currentSlide(4)" >
					    </div>
					</div>
				</div>
			</div>
			<div id="image_slider">
				<img class="image_preview2" src="img/kerambit1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/kerambit2.jpg" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/kerambit3.jpg" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/kerambit4.jpg" onclick="openModal();currentSlide(4)" class="hover-shadow cursor">
			</div>
		</td>
			...
			<table width="100%" cellspacing="0" cellpadding="10px">
				<tr>
					<td colspan="2" style="border-bottom:solid gray;">
						<p>Deskripsi Produk
<pre>
Handmade,bukan PABRIK kualitas dijamin 100%
cocok untuk latihan beladiri/koleksi.
Bahan bilah pisau: Besi

Ukuran:
Panjang total: 20,5cm
Panjang Bilah : 8,5cm
Lebar Bilah : 2,7cm
Panjang Gagang : 12cm
Tebal bilah: 0.25 cm
			...
			<table cellspacing="0" cellpadding="10px" width="100%">
				<tr>
					<td align="center" valign="top">
						<h2>Harga</h2>
						<hr>
						<font size="30" color="red">Rp 60.000</font>
						<p align="center">Stok
