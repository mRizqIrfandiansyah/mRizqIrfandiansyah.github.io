...
<div id="header" >
	...
	<tr>
		<td colspan="3" width="100%">
			<a href="index.php">Home</a> > <a href="pakaian.php">Pakaian</a> > <a href="">Rok Lilit Wanita Kain Batik</a>
		</td>
	</tr>
	<tr>
		<td colspan="3" width="100%"><h2>Rok Lilit Wanita Kain Batik</h2></td>
	</tr>
	<tr>
		<td width="25%" valign="top">
			<div class="image_preview1">
    			<img src="img/rok_1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor" width="100%">
				<div id="myModal" class="modal">
					<span class="close cursor" onclick="closeModal()">&times;</span>
					<div class="modal-content">
					    <div class="mySlides">
					      <div class="numbertext">1 / 4</div>
					      <img src="img/rok_1.jpg" style="width:100%">
					    </div>
					    <div class="mySlides">
					      <div class="numbertext">2 / 4</div>
					      <img src="img/rok_2.jpg" style="width:100%">
					    </div>
					    ...
					    <div class="column">
					      <img class="demo cursor" src="img/rok_1.jpg" style="width:100%" onclick="currentSlide(1)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="img/rok_2.jpg" style="width:100%" onclick="currentSlide(2)" >
					    </div>
					</div>
				</div>
			</div>
			<div id="image_slider">
				<img class="image_preview2" src="img/rok_1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/rok_2.jpg" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
			</div>
		</td>
			...
			<table width="100%" cellspacing="0" cellpadding="10px">
				<tr>
					<td colspan="2" style="border-bottom:solid gray;">
						<p>Deskripsi Produk
<pre>
Foto : akurasi persamaan real sekitaran 80-90%
Bahan : Batik Sutra
Warna : Hijau / Merah / Putih / Gold
Ukuran : muat sampai ukuran L (PR 90cm Lebar 150cm)

Deskripsi : dalam pembelian Rok ini dapat Aksesoris Cantiknya loh kaka.
Motif Bunga cantik sekaliiiii ^_^

>>>Kualitas Baju sesuai dengan Harga<<<
</pre>
					</td>
				</tr>
				<tr>
