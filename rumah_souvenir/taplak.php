...
<div id="header" >
	...
	<tr>
		<td colspan="3" width="100%">
			<a href="index.php">Home</a> > <a href="kerajinan.php">Kerajinan</a> > <a href="">Taplak Meja Tamu Batik Kotak Ronce</a>
		</td>
	</tr>
	<tr>
		<td colspan="3" width="100%"><h2>Taplak Meja Tamu Batik Kotak Ronce</h2></td>
	</tr>
	<tr>
		<td width="25%" valign="top">
			<div class="image_preview1">
    			<img src="img/taplak_1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor" width="100%">
				<div id="myModal" class="modal">
					<span class="close cursor" onclick="closeModal()">&times;</span>
					<div class="modal-content">
					    <div class="mySlides">
					      <div class="numbertext">1 / 3</div>
					      <img src="img/taplak_1.jpg" style="width:100%">
					    </div>
					    <div class="mySlides">
					      <div class="numbertext">2 / 3</div>
					      <img src="img/taplak_2.jpg" style="width:100%">
					    </div>

					    <div class="mySlides">
					      <div class="numbertext">3 / 3</div>
					      <img src="img/taplak_3.jpg" style="width:100%">
					    </div>
					    ...
					    <div class="column">
					      <img class="demo cursor" src="img/taplak_1.jpg" style="width:100%" onclick="currentSlide(1)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="img/taplak_2.jpg" style="width:100%" onclick="currentSlide(2)" >
					    </div>
					    <div class="column">
					      <img class="demo cursor" src="img/taplak_3.jpg" style="width:100%" onclick="currentSlide(3)" >
					    </div>
					</div>
				</div>
			</div>
			<div id="image_slider">
				<img class="image_preview2" src="img/taplak_1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/taplak_2.jpg" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
				<img class="image_preview2" src="img/taplak_3.jpg" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
			</div>
		</td>
...
<pre>
Taplak Meja Kotak, 
Dengan Motif Klasik yg tak lekang oleh zaman,
Dibuat dengan proses batik canting cap, Warna terbukti awet, 
Taplak juga dilengkapi dengan kerajinan ronce. 
Ukuran 100 x 100 cm. 
Menggunakan bahan Kain tebal. 
Taplak ini akan semakin mempercantik ruangan anda.
Tersedia 4 warna:merah,hijau,coklat,biru.
</pre>
					</td>
				</tr>
				<tr>
					...
					<td rowspan="2" align="center">
						<div style="border:2px solid black;font-weight:bold;padding:10px">
							<h2 style="margin:0">Rating</h2><br><hr><font size="30" color="orange">4.0</font>
						</div>
					</td>
				</tr>
				<tr>
			...
			<table cellspacing="0" cellpadding="10px" width="100%">
				<tr>
					<td align="center" valign="top">
						<h2>Harga</h2>
						<hr>
						<font size="30" color="red">Rp 40.000</font>
						<p align="center">Stok
					<div align="center" style="border:1px solid lightgrey;
					width:30%;margin:0 auto;font-size:50;border-radius:10px" id="stok">25</div>
					</td>
				</tr>
				<tr>
					<td>
					<div class="number-input" align="center">
  						...
  						<input id="kurang" class="quantity" min="0" max="25"name="quantity" value="1" type="number">
